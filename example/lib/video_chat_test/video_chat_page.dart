...
class VideoChatPageRoute extends StatefulWidget {
  @override
  _VideoChatPageRouteState createState() => _VideoChatPageRouteState();
}

class _VideoChatPageRouteState extends State<VideoChatPageRoute> {
              ...
              child: GridView.count(
                ...
                children: <Widget>[
                  ...
                  FlatButton(
                    onPressed: () {
                      TrtcRoom.enterRoom(
                          _sdkAppId, _currentUserId, _userSig, _roomId, 0);
                    },
                    child: Text('进入房间'),
                  ),
                  FlatButton(
                    ...
                    onPressed: () {
                      ...
                      switch (_localMirror) {
                        case TrtcVideoMirrorType.TRTC_VIDEO_MIRROR_TYPE_AUTO:
                          _localMirror =
                              TrtcVideoMirrorType.TRTC_VIDEO_MIRROR_TYPE_ENABLE;
                          msg = '前置摄像头和后置摄像头都镜像';
                          break;

                        case TrtcVideoMirrorType.TRTC_VIDEO_MIRROR_TYPE_ENABLE:
                          _localMirror = TrtcVideoMirrorType
                        ...
                        default:
                          _localMirror =
                              TrtcVideoMirrorType.TRTC_VIDEO_MIRROR_TYPE_AUTO;
                  ...
                  FlatButton(
                    onPressed: () {
                      String firstRemoteUserId = _widgetMap.keys
